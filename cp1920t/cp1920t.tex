...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{singleton}\comp \conj{\Varid{nil}}{\Varid{id}}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{nothing}}{\lambda (\Varid{a},(\anonymous ,\Varid{s2}))\to \mathbf{if}\;(\Varid{isNothing}\;\Varid{s2})\;\mathbf{then}\;\Conid{Just}\;\Varid{a}\;\mathbf{else}\;\Varid{s2}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{maisEsq}\mathrel{=}\cata{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\Varid{nothing}}{\lambda (\Varid{a},(\Varid{s1},\anonymous ))\to \mathbf{if}\;(\Varid{isNothing}\;\Varid{s1})\;\mathbf{then}\;\Conid{Just}\;\Varid{a}\;\mathbf{else}\;\Varid{s1}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd'}\;\Varid{x}\mathrel{=}\cata{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\conj{\alt{\Varid{h1}}{\Varid{h2}}}{\alt{\Varid{k1}}{\Varid{k2}}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{rrot}\mathrel{=}\cata{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Empty}}}{\Varid{h}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(\Varid{r},(\Conid{Empty},\Varid{d}))\mathrel{=}\Conid{Node}\;(\Varid{r},(\Conid{Empty},\Varid{d})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(\Varid{r},((\Conid{Node}\;(\Varid{e},(\Varid{ee},\Varid{ed}))),\Varid{d}))\mathrel{=}\Conid{Node}\;(\Varid{e},(\Varid{ee},(\Conid{Node}\;(\Varid{r},(\Varid{ed},\Varid{d}))))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lrot}\mathrel{=}\cata{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Empty}}}{\Varid{h}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(\Varid{r},(\Varid{e},\Conid{Empty}))\mathrel{=}\Conid{Node}\;(\Varid{r},(\Varid{e},\Conid{Empty})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(\Varid{r},(\Varid{e},(\Conid{Node}\;(\Varid{d},(\Varid{de},\Varid{dd})))))\mathrel{=}\Conid{Node}\;(\Varid{d},((\Conid{Node}\;(\Varid{r},(\Varid{e},\Varid{de}))),\Varid{dd})){}\<[E]%
\\[\blanklineskip]%
