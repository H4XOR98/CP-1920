...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\lambda \Varid{a}\;\anonymous \to \Conid{D}\;[\mskip1.5mu (\Conid{Leaf}\;\Varid{a},\mathrm{1})\mskip1.5mu]}{\Varid{aux}}\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Varid{esq},\Varid{dir})\;\Conid{Empty}\mathrel{=}{}\<[28]%
\>[28]{}\bot \mbox{\onelinecomment (>>=) . return . Fork}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Varid{esq},\Varid{dir})\;(\Conid{Node}\;(\Varid{r},(\Varid{e},\Varid{d})))\mathrel{=}\bot {}\<[E]%
\ColumnHook
\end{hscode}\resethooks
