...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\bot \mbox{\onelinecomment either (singl.split nil id) }{}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=5cm{
    \ensuremath{\Conid{Exp}\;\Conid{V}\;\Conid{O}}
           \ar[d]_-{\ensuremath{\Varid{tar}}}
           \ar[r]_-{\ensuremath{\Varid{outExp}}}
&
    \ensuremath{\Conid{V}\mathbin{+}(\Conid{O}\times(\Conid{Exp}\;\Conid{V}\;\Conid{O})\mathbin{*})}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\map \;\Varid{tar})}}
\\
     \ensuremath{(\Conid{O}\mathbin{*}\times\Conid{V})\mathbin{*}}
&
     \ensuremath{\Conid{V}\mathbin{+}(\Conid{O}\times((\Conid{O}\mathbin{*}\times\Conid{V})\mathbin{*})\mathbin{*})}
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\conj{\Varid{id}}{\Varid{id}}\comp \underline{\Conid{Empty}}}{\lambda (\Varid{a},((\Varid{esqI},\Varid{esq}),(\Varid{dirI},\Varid{dir})))\to (\Conid{Node}\;(\Varid{a},(\Varid{esqI},\Varid{dirI})),\Conid{Node}\;(\Varid{a},(\Varid{esq},\Varid{dir})))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd}\;\Varid{a}\;\Conid{Empty}\mathrel{=}{}\<[19]%
\>[19]{}\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Empty})){}\<[E]%
\\
\>[B]{}\Varid{insOrd}\;\Varid{a}\;(\Conid{Node}\;(\Varid{x},(\Varid{esq},\Varid{dir})))\mid \Varid{a}\mathbin{<}\Varid{x}\mathrel{=}\Conid{Node}\;(\Varid{x},(\Varid{insOrd}\;\Varid{a}\;\Varid{esq},\Varid{dir})){}\<[E]%
\\
\>[B]{}\hsindent{32}{}\<[32]%
\>[32]{}\mid \Varid{a}\mathbin{>}\Varid{x}\mathrel{=}\Conid{Node}\;(\Varid{x},(\Varid{esq},\Varid{insOrd}\;\Varid{a}\;\Varid{dir})){}\<[E]%
\\
\>[B]{}\hsindent{32}{}\<[32]%
\>[32]{}\mid \Varid{otherwise}\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{esq},\Varid{dir})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isOrd'}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\conj{\underline{\Conid{True}}}{\underline{\Conid{Empty}}}}{\lambda (\Varid{a},(\Varid{esq},\Varid{dir}))\to \Varid{teste}\;\Varid{a}\;\Varid{esq}\;\Varid{dir}}{}\<[E]%
\\[\blanklineskip]%
...
\xymatrix@C=8cm{
    \ensuremath{\fun{BTree} \;\Conid{A}}
           \ar[d]_-{\ensuremath{\Varid{maisEsq}}}
           \ar[r]_-{\ensuremath{\Varid{outBTree}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A}))}
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{teste}\mathbin{::}(\Conid{Ord}\;\Varid{a})\Rightarrow \Varid{a}\to (\Conid{Bool},\fun{BTree} \;\Varid{a})\to (\Conid{Bool},\fun{BTree} \;\Varid{a})\to (\Conid{Bool},\fun{BTree} \;\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{teste}\;\Varid{a}\;(\Varid{b1},\Conid{Empty})\;(\Varid{b2},\Conid{Empty})\mathrel{=}(\Varid{b1}\equiv \Conid{True}\mathrel{\wedge}\Varid{b2}\equiv \Conid{True},\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Conid{Empty}))){}\<[E]%
\\
\>[B]{}\Varid{teste}\;\Varid{a}\;(\Varid{b1},\Conid{Empty})\;(\Varid{b2},(\Conid{Node}\;(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{b1}\equiv \Conid{True}\mathrel{\wedge}\Varid{b2}\equiv \Conid{True}\mathrel{\wedge}\Varid{a}\leq \Varid{c},\Conid{Node}\;(\Varid{a},(\Conid{Empty},(\Conid{Node}\;(\Varid{c},\Varid{d}))))){}\<[E]%
\\
\>[B]{}\Varid{teste}\;\Varid{a}\;(\Varid{b1},(\Conid{Node}\;(\Varid{c},\Varid{d})))\;(\Varid{b2},\Conid{Empty})\mathrel{=}(\Varid{b1}\equiv \Conid{True}\mathrel{\wedge}\Varid{b2}\equiv \Conid{True}\mathrel{\wedge}\Varid{a}\geq \Varid{c},\Conid{Node}\;(\Varid{a},(((\Conid{Node}\;(\Varid{c},\Varid{d}))),\Conid{Empty}))){}\<[E]%
\\
\>[B]{}\Varid{teste}\;\Varid{a}\;(\Varid{b1},(\Conid{Node}\;(\Varid{c},\Varid{d})))\;(\Varid{b2},(\Conid{Node}\;(\Varid{x},\Varid{y})))\mathrel{=}(\Varid{b1}\equiv \Conid{True}\mathrel{\wedge}\Varid{b2}\equiv \Conid{True}\mathrel{\wedge}\Varid{a}\geq \Varid{c}\mathrel{\wedge}\Varid{a}\leq \Varid{x},{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Conid{Node}\;(\Varid{a},(((\Conid{Node}\;(\Varid{c},\Varid{d}))),((\Conid{Node}\;(\Varid{x},\Varid{y})))))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
