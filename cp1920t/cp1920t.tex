...
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 rd}\;\Varid{p}\;\Varid{t}\mathrel{=}\Varid{h}\mathbin{\$}(\Varid{concat}\comp \map \;\p2\comp \Varid{filter}\;((\Varid{p}\equiv )\comp \p1)\comp \Varid{dic\char95 exp})\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{h}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{Nothing}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;\Varid{l}\mathrel{=}{}\<[16]%
\>[16]{}\Conid{Just}\;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
