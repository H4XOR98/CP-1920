...
\begin{enumerate}
  \item Definir as funções \ensuremath{\Varid{inBdt}}, \ensuremath{\Varid{outBdt}}, \ensuremath{\Varid{baseBdt}}, \ensuremath{\cata{\cdot }}, e \ensuremath{\ana{\cdot }}.
...
\\
\>[B]{}\Varid{tipsBdt}\mathrel{=}\cata{\alt{\Varid{singl}}{\uncurry{(\plus )}\comp \p2}}{}\<[E]%
\\
...
\\
\>[B]{}\Varid{discollect}\mathrel{=}\Varid{concat}\comp \map \;\Varid{lstr}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{tar}\mathbin{::}\Conid{Exp}\;\Varid{c}\;\Conid{String}\to [\mskip1.5mu (\Conid{String},\Varid{c})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{tar}\mathrel{=}\cata{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\mathrel{=}\Varid{singleton}\comp \conj{\Varid{nil}}{\Varid{id}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\mathrel{=}\uncurry{\Varid{zip}}\comp \conj{(\map \;\uncurry{(\plus )})\comp \Varid{discollect}\comp \Varid{singleton}\comp \conj{\p1}{(\map \;\p1)\comp \p2}}{(\map \;\p2)\comp \p2}\comp (\Varid{id}\times\Varid{concat}){}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{dic\char95 rd}\;\Varid{p}\;\Varid{t}\mathrel{=}(\mathbf{if}\;(\Varid{result}\equiv [\mskip1.5mu \mskip1.5mu])\;\mathbf{then}\;\Varid{nothing}\;\mathbf{else}\;\Conid{Just})\;\Varid{result}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{result}\mathrel{=}(\Varid{concat}\comp \map \;\p2\comp \Varid{filter}\;((\Varid{p}\equiv )\comp \p1)\comp \Varid{dic\char95 exp})\;\Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{dic\char95 in}\mathbin{::}\Conid{String}\to \Conid{String}\to \Conid{Dict}\to \Conid{Dict}{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 in}\;\text{\ttfamily \char34 \char34}\;\anonymous \;\Varid{z}\mathrel{=}\Varid{z}{}\<[E]%
\\
\>[B]{}\Varid{dic\char95 in}\;\Varid{x}\;\Varid{y}\;\Varid{z}\mathrel{=}\Varid{f}\;((\Varid{x},\Varid{y}),\Varid{z}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{f}\mathrel{=}\Varid{dic\char95 imp}\comp (\Varid{sortBy}\;\Varid{compare})\comp \mathsf{conc}\comp (\Varid{singl}\times\Varid{id})\comp (\conj{\p1}{\Varid{singl}\comp \p2}\times\Varid{dic\char95 exp}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{eqnarray*}
\xymatrix@C=5cm{
    \ensuremath{\Conid{Exp}\;\Conid{V}\;\Conid{O}}
           \ar[d]_-{\ensuremath{\Varid{tar}\mathrel{=}\cata{\Varid{g}}}}
           \ar[r]_-{\ensuremath{\Varid{outExp}}}
&
    \ensuremath{\Conid{V}\mathbin{+}\Conid{O}\times(\Conid{Exp}\;\Conid{V}\;\Conid{O})\;^*}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\map \;\Varid{tar})}}
\\
     \ensuremath{(\Conid{O}\times\Conid{V})\;^*}
&
     \ensuremath{\Conid{V}\mathbin{+}\Conid{O}\times((\Conid{O}\times\Conid{V})\;^*)\;^*}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{singl}\comp \conj{\Varid{nil}}{\Varid{id}}}{\Varid{g2}}}}
}
\end{eqnarray*}
...
& 
      \ensuremath{\Conid{O}\times((\Conid{O}\times\Conid{V})\;^*)\;^*} 
          \ar[d]^-{\ensuremath{\Varid{id}\times\Varid{concat}}} 
&  
\\
      \ensuremath{\Conid{O}\times\Conid{O}\;^*} 
          \ar[d]^-{\ensuremath{\Varid{b}\mathrel{=}\Varid{discollect}\comp \Varid{singleton}}} 
& 
      \ensuremath{\Conid{O}\times(\Conid{O}\times\Conid{V})\;^*} 
          \ar[l]^-{\ensuremath{\Varid{a}\mathrel{=}\conj{\p1}{(\map \;\p1)\comp \p2}}} 
          \ar[r]^-{\ensuremath{\Varid{e}\mathrel{=}(\map \;\p2)\comp \p2}} 
          \ar[d]^-{\ensuremath{\Varid{f}\mathrel{=}\conj{\Varid{d}}{\Varid{e}}}} 
          \ar[ddl]^-{\ensuremath{\Varid{d}\mathrel{=}\Varid{c}\comp \Varid{b}\comp \Varid{a}}}  
& 
      \ensuremath{\Conid{V}\;^*} 
\\
      \ensuremath{(\Conid{O}\times\Conid{O})\;^*} 
          \ar[d]^-{\ensuremath{\Varid{c}\mathrel{=}\map \;\uncurry{(\plus )}}} 
& 
      \ensuremath{\Conid{O}\;^*\times\Conid{V}\;^*}
          \ar[d]^-{\ensuremath{\Varid{h}\mathrel{=}\uncurry{\Varid{zip}}}} 
&  
\\
      \ensuremath{\Conid{O}\;^*}  
& 
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{maisDir}\mathrel{=}\cata{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{nothing}}{\lambda (\Varid{a},(\anonymous ,\Varid{s2}))\to \mathbf{if}\;(\Varid{isNothing}\;\Varid{s2})\;\mathbf{then}\;\Conid{Just}\;\Varid{a}\;\mathbf{else}\;\Varid{s2}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{maisEsq}\mathrel{=}\cata{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{nothing}}{\lambda (\Varid{a},(\Varid{s1},\anonymous ))\to \mathbf{if}\;(\Varid{isNothing}\;\Varid{s1})\;\mathbf{then}\;\Conid{Just}\;\Varid{a}\;\mathbf{else}\;\Varid{s1}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd'}\;\Varid{x}\mathrel{=}\cata{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\conj{\alt{\Varid{h1}}{\Varid{h2}}}{\alt{\Varid{k1}}{\Varid{k2}}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h1}\;()\mathrel{=}\Conid{Node}\;(\Varid{x},(\Conid{Empty},\Conid{Empty})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h2}\;(\Varid{a},((\Varid{esqIns},\Varid{esq}),(\Varid{dirIns},\Varid{dir})))\mathrel{=}\Varid{curry}\;\Conid{Node}\;\Varid{a}\mathbin{\$}\mathbf{if}\;(\Varid{x}\mathbin{<}\Varid{a})\;\mathbf{then}\;(\Varid{esqIns},\Varid{dir})\;\mathbf{else}\;(\Varid{esq},\Varid{dirIns}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k1}\;()\mathrel{=}\Conid{Empty}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{k2}\;(\Varid{a},((\Varid{esqIns},\Varid{esq}),(\Varid{dirIns},\Varid{dir})))\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{esq},\Varid{dir})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{insOrd}\;\Varid{a}\;\Varid{x}\mathrel{=}\p1\comp (\Varid{insOrd'}\;\Varid{a})\mathbin{\$}\Varid{x}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isOrd'}\mathrel{=}\cata{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isOrd}\mathrel{=}(\lambda \Varid{l}\to \Varid{and}\mathbin{\$}\Varid{zipWith}\;(\leq )\;\Varid{l}\;(\Varid{tail}\;\Varid{l}))\comp \Varid{inordt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rrot}\mathrel{=}\cata{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\underline{\Conid{Empty}}}{\Varid{h}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\;(\Varid{r},(\Conid{Empty},\Varid{d}))\mathrel{=}\Conid{Node}\;(\Varid{r},(\Conid{Empty},\Varid{d})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\;(\Varid{r},(\Conid{Node}\;(\Varid{e},(\Varid{ee},\Varid{ed})),\Varid{d}))\mathrel{=}\Conid{Node}\;(\Varid{e},(\Varid{ee},(\Conid{Node}\;(\Varid{r},(\Varid{ed},\Varid{d}))))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lrot}\mathrel{=}\cata{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\underline{\Conid{Empty}}}{\Varid{h}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\;(\Varid{r},(\Varid{e},\Conid{Empty}))\mathrel{=}\Conid{Node}\;(\Varid{r},(\Varid{e},\Conid{Empty})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{h}\;(\Varid{r},(\Varid{e},\Conid{Node}\;(\Varid{d},(\Varid{de},\Varid{dd}))))\mathrel{=}\Conid{Node}\;(\Varid{d},((\Conid{Node}\;(\Varid{r},(\Varid{e},\Varid{de}))),\Varid{dd})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{splay}\mathrel{=}\Varid{flip}\;\cata{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{curry}\;\underline{\Conid{Empty}}}{\Varid{aux}}\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Varid{r},(\Varid{esq},\Varid{dir}))\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{Node}\;(\Varid{r},(\Varid{esq}\;[\mskip1.5mu \mskip1.5mu],\Varid{dir}\;[\mskip1.5mu \mskip1.5mu])){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Varid{r},(\Varid{esq},\Varid{dir}))\;\Varid{l}\mathrel{=}(\mathbf{if}\;(\Varid{head}\;\Varid{l}\equiv \Conid{True})\;\mathbf{then}\;\Varid{esq}\;\mathbf{else}\;\Varid{dir})\mathbin{\$}\Varid{tail}\;\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times(\Conid{Maybe}\;\Conid{A}\times\Conid{Maybe}\;\Conid{A})}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{nothing}}{\lambda (\Varid{a},(\anonymous ,\Varid{s2}))\to \mathbf{if}\;(\Varid{isNothing}\;\Varid{s2})\;\mathbf{then}\;\Conid{Just}\;\Varid{a}\;\mathbf{else}\;\Varid{s2}}}}
}
\end{eqnarray*}
...
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times(\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A})}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{maisEsq}\times\Varid{maisEsq})}}
\\
     \ensuremath{\Conid{Maybe}\;\Conid{A}}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\Conid{Maybe}\;\Conid{A}\times\Conid{Maybe}\;\Conid{A}))}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{nothing}}{\lambda (\Varid{a},(\Varid{s1},\anonymous ))\to \mathbf{if}\;(\Varid{isNothing}\;\Varid{s1})\;\mathbf{then}\;\Conid{Just}\;\Varid{a}\;\mathbf{else}\;\Varid{s1}}}}
}
\end{eqnarray*}
...
&
    \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A}))}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\times(\Varid{insOrd'}\times\Varid{insOrd'}))}}
\\
     \ensuremath{(\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A})}
     \ar[d]_-{\ensuremath{\p1}}
&
     \ensuremath{\mathrm{1}\mathbin{+}(\Conid{A}\times(\fun{BTree} \;\Conid{A}\;^2\times\fun{BTree} \;\Conid{A}\;^2))}
           \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\conj{\alt{\Varid{h1}}{\Varid{h2}}}{\alt{\Varid{k1}}{\Varid{k2}}}}}
\\
    \ensuremath{\fun{BTree} \;\Conid{A}}
}
\end{eqnarray*}
...
&
\ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times(\fun{BTree} \;\Conid{A}\times\fun{BTree} \;\Conid{A})}
    \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{inordt}\times\Varid{inordt})}}
\\
\ensuremath{\Conid{A}\;^*}
...
\\
      \ensuremath{\fun{BTree} \;\Conid{A}\;^{Bool\ ^*}} 
& 
      \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times(\fun{BTree} \;\Conid{A}\;^{Bool\ ^*}\times\fun{BTree} \;\Conid{A}\;^{Bool\ ^*})}
          \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{curry}\;\underline{\Conid{Empty}}}{\Varid{aux}}}} 
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{isNothing}\mathbin{::}\Conid{Maybe}\;\Varid{a}\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{isNothing}\;\Conid{Nothing}\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{isNothing}\;\anonymous \mathrel{=}\Conid{False}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{extLTree}\mathrel{=}\cata{\Varid{g}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{baseBdt}\;\Varid{f}\;\Varid{g}\;\Varid{h}{}\<[16]%
\>[16]{}\mathrel{=}\Varid{f}+(\Varid{g}{}\<[28]%
\>[28]{}\times(\Varid{h}\times\Varid{h})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recBdt}\;\Varid{f}\mathrel{=}\Varid{baseBdt}\;\Varid{id}\;\Varid{id}\;\Varid{f}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\cata{\Varid{a}}\mathrel{=}\Varid{a}\comp (\Varid{recBdt}\;\cata{\Varid{a}})\comp \Varid{outBdt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\ana{\Varid{f}}\mathrel{=}\Varid{inBdt}\comp (\Varid{recBdt}\;\ana{\Varid{f}})\comp \Varid{f}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{curry}\;(\Conid{Leaf}\comp \p1)}{\Varid{aux}}\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Varid{esq},\Varid{dir})\;[\mskip1.5mu \mskip1.5mu]{}\<[23]%
\>[23]{}\mathrel{=}\Conid{Fork}\;(\Varid{esq}\;[\mskip1.5mu \mskip1.5mu],\Varid{dir}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Varid{esq},\Varid{dir})\;\Varid{l}\mathrel{=}(\mathbf{if}\;(\Varid{head}\;\Varid{l}\equiv \Conid{True})\;\mathbf{then}\;\Varid{esq}\;\mathbf{else}\;\Varid{dir})\mathbin{\$}\Varid{tail}\;\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
      \ensuremath{\Conid{A}\mathbin{+}\mathit B\times(\Conid{Bdt}\;\Conid{A}\times\Conid{Bdt}\;\Conid{A})} 
...
& 
      \ensuremath{\Conid{FC}} 
          \ar[u]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\ana{\Varid{g}}\times\ana{\Varid{g}})}} 
}
\end{eqnarray*}
...
\xymatrix@C=4cm{
    \ensuremath{\Conid{Bdt}\;\Conid{A}}
        \ar[d]^-{\ensuremath{\Varid{extLTree}\mathrel{=}\cata{\Varid{g}}}}
        \ar[r]^-{outBdt}
&
    \ensuremath{\Conid{A}\mathbin{+}\mathit B\times(\Conid{Bdt}\;\Conid{A}\times\Conid{Bdt}\;\Conid{A})}
        \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{extLTree}\times\Varid{extLTree})}}
\\
...
\xymatrix@C=4cm{
    \ensuremath{\mathsf{LTree}\;\Conid{A}}
        \ar[d]^-{\ensuremath{\Varid{navLTree}\mathrel{=}\Varid{cataLTree}\;\Varid{g}}}
        \ar[r]^-{outLTree}
&
...
\\
    \ensuremath{\mathsf{LTree}\;\Conid{A}\;^{Bool\ ^*}}
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\;^{Bool\ ^*}\times\mathsf{LTree}\;\Conid{A}\;^{Bool\ ^*})}
        \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{curry}\;(\Conid{Leaf}\comp \p1)}{\Varid{aux}}}}
}
\end{eqnarray*}
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Varid{esq},\Varid{dir})\;\Conid{Empty}{}\<[26]%
\>[26]{}\mathrel{=}\Conid{Fork}\;(\Varid{esq}\;\Conid{Empty},\Varid{dir}\;\Conid{Empty}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Varid{esq},\Varid{dir})\;(\Conid{Node}\;(\Varid{r},(\Varid{e},\Varid{d})))\mathrel{=}\mathbf{if}\;(\Varid{r}\equiv \Conid{True})\;\mathbf{then}\;\Varid{esq}\;\Varid{e}\;\mathbf{else}\;\Varid{dir}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pbnavLTree}\mathrel{=}\Varid{cataLTree}\;\Varid{g}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\lambda \Varid{x}\;\anonymous \to \Conid{D}\mathbin{\$}\Varid{singl}\;(\Conid{Leaf}\;\Varid{x},\mathrm{1})}{\Varid{aux}}\;\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Varid{esq},\Varid{dir})\;\Conid{Empty}\mathrel{=}{}\<[28]%
\>[28]{}(\bind )\;(\Varid{prod}\;(\Varid{esq}\;\Conid{Empty})\;(\Varid{dir}\;\Conid{Empty}))\;(\Varid{return}\comp \Conid{Fork}){}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Varid{aux}\;(\Varid{esq},\Varid{dir})\;(\Conid{Node}\;(\Varid{r},(\Varid{e},\Varid{d})))\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{r'}\leftarrow \Varid{r};\mathbf{if}\;(\Varid{r'}\equiv \Conid{True})\;\mathbf{then}\;\Varid{esq}\;\Varid{e}\;\mathbf{else}\;\Varid{dir}\;\Varid{d}\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=4cm{
    \ensuremath{\mathsf{LTree}\;\Conid{A}}
        \ar[d]^-{\ensuremath{\Varid{bnavLTree}\mathrel{=}\Varid{cataLTree}\;\Varid{g}}}
        \ar[r]^-{outLTree}
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\times\mathsf{LTree}\;\Conid{A})}
        \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}(\Varid{bnavLTree}\times\Varid{bnavLTree})}}
\\
    \ensuremath{\mathsf{LTree}\;\Conid{A}\;^{\fun{BTree} \ Bool}}
&
    \ensuremath{\Conid{A}\mathbin{+}(\mathsf{LTree}\;\Conid{A}\;^{\fun{BTree} \ Bool}\times\mathsf{LTree}\;\Conid{A}\;^{\fun{BTree} \ Bool})}
        \ar[l]^-{\ensuremath{\Varid{g}\mathrel{=}\alt{\Varid{curry}\;(\Conid{Leaf}\comp \p1)}{\Varid{aux}}}}
}
\end{eqnarray*}
