...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g}\mathrel{=}\alt{\Varid{curry}\;(\Conid{Leaf}\comp \p1)}{\Varid{aux}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{aux}\;(\Varid{esq},\Varid{dir})\;[\mskip1.5mu \mskip1.5mu]{}\<[21]%
\>[21]{}\mathrel{=}\Conid{Fork}\;(\Varid{esq}\;[\mskip1.5mu \mskip1.5mu],\Varid{dir}\;[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{aux}\;(\Varid{esq},\Varid{dir})\;\Varid{l}{}\<[21]%
\>[21]{}\mathrel{=}(\mathbf{if}\;(\Varid{head}\;\Varid{l}\equiv \Conid{True})\;\mathbf{then}\;\Varid{esq}\;\mathbf{else}\;\Varid{dir})\mathbin{\$}\Varid{tail}\;\Varid{l}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
