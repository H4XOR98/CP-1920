...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h1}\;()\mathrel{=}\Conid{Node}\;(\Varid{x},(\Conid{Empty},\Conid{Empty})){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h2}\;(\Varid{a},((\Varid{esqIns},\Varid{esq}),(\Varid{dirIns},\Varid{dir})))\mathrel{=}\Varid{curry}\;\Conid{Node}\;\Varid{a}\mathbin{\$}\mathbf{if}\;(\Varid{x}\mathbin{<}\Varid{a})\;\mathbf{then}\;(\Varid{esqIns},\Varid{dir})\;\mathbf{else}\;(\Varid{esq},\Varid{dirIns}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k1}\;()\mathrel{=}\Conid{Empty}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k2}\;(\Varid{a},((\Varid{esqIns},\Varid{esq}),(\Varid{dirIns},\Varid{dir})))\mathrel{=}\Conid{Node}\;(\Varid{a},(\Varid{esq},\Varid{dir})){}\<[E]%
\\[\blanklineskip]%
